...
@ReactModule(name = MatrixCryptoModule.NAME)
class MatrixCryptoModule(reactContext: ReactApplicationContext) :
  NativeMatrixCryptoSpec(reactContext) {
  ...
  // react-native-matrix-crypto.cpp
  ...
  companion object {
    const val NAME = "MatrixCrypto"

    init {
      System.loadLibrary("react-native-matrix-crypto")
    }
  }
}