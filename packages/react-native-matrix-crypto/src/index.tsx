...
import installer from './NativeMatrixCrypto';
...
export * from './generated/matrix_crypto';

// Now import the bindings so we can:
// - intialize them
// - export them as namespaced objects as the default export.
import * as matrix_crypto from './generated/matrix_crypto';
...
if (!initialized) {
  matrix_crypto.default.initialize();
  initialized = true;
}
